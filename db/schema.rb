...
ActiveRecord::Schema.define(version: 20140927164358) do
  ...
  add_index "banners", ["resource_id", "resource_type"], name: "index_banners_on_resource_id_and_resource_type", using: :btree
